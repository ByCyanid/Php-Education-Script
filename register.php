			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 pl-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <h5 class="text-muted font-weight-normal mb-4">Hoşgeldin! Hemen Kayıt Ol!</h5>
                    <div class="forms-sample">
					 <div class="form-group">
					   ...
					   <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="telefon" placeholder="Telefon Numaran">
                      </div>
					     <div class="form-group">
                        <label for="username">Email Adresin : </label>
                      ...
                      <div class="mt-3">
                        <button  id="btn-register" class="btn btn-primary mr-2 mb-2 mb-md-0 text-white">Kayıt Ol</button>
                       
                      </div>
                      <a href="index.php" class="d-block mt-3 text-muted">Hesabınız var mı? Hemen giriş yapın!</a>
                    </div>
                  </div>
                </div>
              </div>
