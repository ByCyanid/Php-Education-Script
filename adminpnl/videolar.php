...
<?php include ('inc/header.php'); ?>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-2">
                  <h6 class="card-title mb-0">Tüm Eğitimler <a href="yeniegitim.php" class="btn btn-success">YENİ EĞİTİM EKLE</a></h6>
                                        ...
                                        <table id="myTable"  class="table table-hover-animation mb-0">
											...
											?>
												<tr class="active">
												 ...
												 <td><?php echo $fetch_r['egitimaciklama']; ?></td>
												 <td><a href="../themes/egitimler/<?php echo $fetch_r['egitimvideo']; ?>" target="_blank">GÖR</a></td>
												 <td> <span id="<?php echo $fetch_r['id']; ?>" class="badge badge-warning animalbuymussil"><i class="far fa-trash-alt"></i></span></td>
												</tr>
											<?php
													$i++;}
												}else{
  ...
  <?php include ('inc/footer.php'); ?>
	...
	swal({
	  ...
	  text: "Onayladığın takdirde bu eğitimi  tamamen sileceksiniz!",
	  type: "warning",
	...
	type:'POST',
	data:'id='+id,
	url:'system/ajax/egitimsil.php',
	success:function(reply) {
	if (reply == 0) {
	swal("Tebrikler!", "Eğitim bilgileri  tamamen kaldırıldı", "success");
	setTimeout(function(){
	location.href = "videolar.php";
	},1000);
	}
	if (reply == 1) {
